...
> **SanHsien Maintained Fork**: Upstream English specification and documentation with Windows-only governance. Fork documentation: [`FORK.md`](FORK.md) · Review records: [`REVIEW.md`](REVIEW.md). `origin`: [`SanHsien/agent-governance-toolkit`](https://github.com/SanHsien/agent-governance-toolkit) | `upstream`: [`microsoft/agent-governance-toolkit`](https://github.com/microsoft/agent-governance-toolkit). Operating System: **Windows only** (Windows 11 / Windows Server with PowerShell).
...
🌍 Also in: [繁體中文](docs/i18n/quickstart.zh-TW.md)
